    ...
    <Layout user={user} loading={loading} title="Dashboard">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        <div className="bg-white p-6 shadow-sm border-0">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <Icon name="wallet" className="text-2xl text-blue-600" />
            </div>
            <div className="ml-4">
        ...
        <div className="bg-white p-6 shadow-sm border-0">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <Icon name="task" className="text-2xl text-green-600" />
            </div>
            <div className="ml-4">
        ...
        <div className="bg-white p-6 shadow-sm border-0">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <Icon name="share" className="text-2xl text-purple-600" />
            </div>
            <div className="ml-4">
        ...
        <div className="bg-white p-6 shadow-sm border-0">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <Icon name="group" className="text-2xl text-orange-600" />
            </div>
            <div className="ml-4">
      ...
      <div className="grid grid-cols-2 gap-4 mb-8 sm:grid-cols-4">
        ...
        >
          <Icon name="task" className="text-2xl text-blue-600 mb-2" />
        ...
        <a
          ...
          className="bg-white p-4 shadow-sm border-0 text-center hover:bg-gray-50 transition-colors"
        >
          <Icon name="money" className="text-2xl text-green-600 mb-2" />
        ...
        <a
          ...
          className="bg-white p-4 shadow-sm border-0 text-center hover:bg-gray-50 transition-colors"
        >
          <Icon name="share" className="text-2xl text-purple-600 mb-2" />
        ...
        <a
          ...
          className="bg-white p-4 shadow-sm border-0 text-center hover:bg-gray-50 transition-colors"
        >
          <Icon name="profile" className="text-2xl text-orange-600 mb-2" />
